      ...
      <div className="mx-auto max-w-6xl px-6 md:px-8 py-8 md:py-16 grid md:grid-cols-2 gap-10 lg:gap-16 items-center">
        ...
        <div className="md:bg-white md:shadow-xl md:rounded-2xl md:p-8 md:py-10 md:border border-border-gray md:max-w-lg md:justify-self-end w-full">
          ...
          <div className="md:hidden mb-8">
            <h1 className="text-[30px] font-medium text-text-primary font-['Poppins'] mb-2">Selamat Datang!</h1>
            <p className="text-[12px] font-medium text-text-primary font-['Poppins']">Masuk Untuk Melanjutkan</p>
          </div>

          {/* Email */}
          <div className="mb-6">
            <label className="block text-[14px] md:text-sm font-medium text-text-primary font-['Poppins'] mb-2">Email atau NPM</label>
            <input
              type="text"
              value={email}
          ...
          {/* Password */}
          <div className="mb-4">
            <label className="block text-[14px] md:text-sm font-medium text-text-primary font-['Poppins'] mb-2">Kata Sandi</label>
            <div className="relative">
              ...
              />
              <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-4 top-1/2 -translate-y-1/2 opacity-80">
                {showPassword ? <Eye className="w-4 h-4 text-black" /> : <EyeOff className="w-4 h-4 text-black" />}
              </button>
            </div>
          </div>
          ...
          <div className="mb-6 text-right">
            <a href="#" className="text-[12px] md:text-sm font-medium font-['Poppins'] text-link-blue underline">Lupa Kata Sandi ?</a>
          </div>

          {/* Submit */}
          <button onClick={handleLogin} className={cn("w-full h-[50px] rounded-full text-white text-[14px] md:text-base font-semibold font-['Poppins'] mb-8 transition-opacity","bg-login-gradient opacity-90 hover:opacity-100")}>Masuk</button>

          {/* Divider */}
          <div className="text-center mb-6">
            <span className="text-[14px] md:text-sm font-medium text-text-primary font-['Poppins']">Atau Lanjut Dengan</span>
          </div>

          {/* Google */}
          <button onClick={handleGoogleLogin} className="w-full h-[50px] flex items-center justify-center space-x-3 border-[1.5px] border-text-secondary rounded-lg bg-white hover:bg-gray-50 transition-colors">
            ...
            <span className="text-[14px] md:text-sm font-semibold text-text-secondary font-['Poppins']">Google</span>
          </button>
